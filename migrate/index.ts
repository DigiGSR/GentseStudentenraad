...
(6, 'GSR', true, '{gsr.staging.gentsestudentenraad.be}', 'https://example.com!', 'https://example.com', 'https://instagram.com', 'https://example.com', 'https://example.com', 'https://example.com', 'Hoveniersberg 24, 9000 Gent', '041234567', 'info@studentenraad.be', '#550123', '#550123', 'https://gentsestudentenraad.be/static/persistent/images/logo.png', 'Gentse Studentenraad', 'De Gentse Studentenraad is de centrale studentenraad van de Universiteit Gent', true, true, true, true, true, true, 'https://example.com', 'https://gentsestudentenraad.be/static/persistent/images/7a2e803a-f3c1-47c2-bfe6-298aca6b09b1-DB-GSR-2.jpg', true, true),
(2, 'PPSR', true, '{ppsr.staging.gentsestudentenraad.be}', null, null, null, null, null, null, null, null, 'ppsr@ugent.be', '#6F0105', '#6F0105', 'https://ppsr.ugent.be/static/persistent/images/dba6f6f0-846f-401d-8d78-65b80c775c95-LogoPPSRA2white.png', 'PPSR', 'De Psychologische en Pedagogische Studentenraad (PPSR) is de facultaire studentenraad van de Faculteit Psychologie en Pedagogische Wetenschappen.', true, true, true, true, true, true, null, 'https://unsplash.com/photos/KTfAuP8gtYM/download?force=true&w=1920', true, false),
