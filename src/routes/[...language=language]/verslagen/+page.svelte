...
<template>
    <div class="flex flex-col px-6 space-y-4 py-12 items-start">
        ...
        <p>{@html data.i18n[$selectedLanguage].get("hier-vind-je-verslagen")}</p>
        <div class="space-y-4 w-full">
            {#if currentReports.length < 1}
                <p>
                    {@html data.i18n[$selectedLanguage].get("werkgroep-geen-verslagen")}Deze
                    werkgroep heeft nog geen verslagen...
                </p>
            {/if}
